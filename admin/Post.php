            ...
            <table class="table t1 table-striped-custom">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 195px; max-width: 195px;">Title</th> <!-- Adjust width for Title -->
                        <th style="min-width: 135px; max-width: 135px;">Category</th>
                        <th style="min-width: 118px;">Comments</th>
                        <th style="min-width: 89px;">Likes</th>
                        <th style="min-width: 89px;">Dislikes</th>
                        <th style="min-width: 89px;">Shares</th>
